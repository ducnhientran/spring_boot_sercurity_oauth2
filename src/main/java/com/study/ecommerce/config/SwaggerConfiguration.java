...
//    public static final String authorizationScopeGlobalDesc = "accessEverything";
    ...
    public Docket productApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.study.ecommerce.controller"))
                // .paths(PathSelectors.regex("/secure.*"))
                .build()
                .securityContexts(Collections.singletonList(securityContext()))
                .securitySchemes(Collections.singletonList(securitySchema()/*, apiKey(), apiCookieKey()*/))
                .apiInfo(apiInfo());
    }
    ...
    public SecurityConfiguration security() {
        return SecurityConfigurationBuilder.builder()
                ...
                .appName("Ecommerce oauth2 ")
                .scopeSeparator("")
                .build();
//        return new SecurityConfiguration("appuser", "apppass", "", "", "Bearer access token", ApiKeyVehicle.HEADER,
